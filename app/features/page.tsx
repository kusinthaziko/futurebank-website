...
const features = [
  ...
  { icon: "💰", title: "Savings Accounts", desc: "Open a savings account, set goals, and track progress. Earn interest on your balance.", category: "Banking" },
  ...
  { icon: "🪪", title: "Financial Passport", desc: "A blockchain-verified record of your financial history. Take it with you after graduation.", category: "Identity" },
  ...
  { icon: "⛓️", title: "Blockchain KYC", desc: "Your identity is verified on-chain. Tamper-proof, portable, and instantly verifiable.", category: "Security" },
];
        ...
        <div key={cat} className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {features.filter(f => f.category === cat).map(f => (
              <div key={f.title} className="rounded-3xl border border-[var(--border)] p-7 hover:-translate-y-1 hover:border-[var(--blue)] transition-all duration-200"
